                                     ...
                                     <div class="all-form-element-inner">
                                        <form action="{{route('diagnostics.update',$diagnostic)}}" method="POST">
                                            ...
                                            {{method_field('PUT')}}
                                              ...
                                              <div class="row">
                                                   <div class="col-lg-6">
                                                       <textarea name="Diagnostic_Principale" id="" cols="30" rows="10"  title="Diagnostic Principale" class="form-control">{{$diagnostic->Diagnostic_Principale}}</textarea>
                                                   </div>
                                                   <div class="col-lg-6">
                                                       <textarea name="Diagnostic_Différentiel" id="" cols="30" rows="10"  title="Diagnostics Différentiels" class="form-control">{{$diagnostic->Diagnostic_Différentiel}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <textarea name="Diagnostic_Travail" id="" cols="30" rows="10"   title="Diagnostic De Travail" class="form-control">{{$diagnostic->Diagnostic_Travail}}</textarea>
                                                    </div>
                                                </div>
                                             </div>
                                             <div class="form-group-inner">
                                           ...
                                           <a href="{{route('diagnostics.index')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
