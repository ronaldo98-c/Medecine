                   ...
                   <div class="modal-dialog">
                      <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('a_obstetricaus.store')}}" method="POST">
                                    {{csrf_field()}}
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                  <input type="text" name="Gravidité" class="form-control"title="Gravidité:Préciser Entier de 1 a 30" placeholder="Préciser Entier de 1 a 30" required>
                                            </div>
                                            <div class="col-lg-6">
                                                 <input type="date" name="Date" class="form-control" title="Date:Information sur La Grossesse" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                 <input type="number" name="CPN" class="form-control" title="CPN:Information sur La Grossesse(de 1 a 10)">
                                            </div>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-6">
                                            <textarea name="Parité" cols="30" rows="10" class="form-control" placeholder="Exemple:enfant a terme(pourcentage)" title="Information sur La Grossesse" required></textarea>
                                          </div>
                                        </div>
                                    </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Antécédents obstétricaux</h1>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="name" data-editable="false">Gravidité</th>
                                                    <th data-field="email" data-editable="false">Parité</th>
                                                    <th data-field="Hypocholestérolemiant" data-editable="false">Date</th>
                                                    <th data-field="Antidépresseurs" data-editable="false">CPN</th>
                                                    <th data-field="Antibiotiques" data-editable="false">Accouchement</th>
                                                    <th data-field="Antituberculeux" data-editable="false">Pathologies</th>
                                                    <th data-field="modifier" data-editable="false">Modifier</th>
                                                    <th data-field="supprimer" data-editable="false">Supprimer</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                              @if(count($a_obstetricaus) > 0)
                                              @foreach($a_obstetricaus as $a_obstetricaux)
                                              <tr>
                                                    <td>{{$a_obstetricaux->id}}</td>
                                                    <td>{{$a_obstetricaux->patient_id}}</td>
                                                    <td>{{$a_obstetricaux->patient_name}}</td>
                                                    <td>{{$a_obstetricaux->Gravidité}}</td>
                                                    <td>{{$a_obstetricaux->Parité}}</td>
                                                    <td>{{$a_obstetricaux->Date}}</td>
                                                    <td>{{$a_obstetricaux->CPN}}</td>
                                                    <td>{{$a_obstetricaux->Accouchement}}</td>
                                                    <td>{{$a_obstetricaux->Pathologies}}</td>
                                                    <td ><a href="{{route('a_obstetricaus.edit',$a_obstetricaux)}}"><img src="img/logo/edit.png" alt=""></a></td>
                                                    <td><a href="{{route('a_obstetricaus.destroy',$a_obstetricaux)}}" data-method="DELETE" data-confirm="Etes vous sure?"><img src="img/logo/delete.png" alt=""></a></td>
                                                </tr>
                                                @endforeach
                                               @else
                                               <tr>
