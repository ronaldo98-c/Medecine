                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="Utérus_cicatriciel" data-editable="false">Utérus cicatriciel</th>
                                                    <th data-field="Utérus_myomateux" data-editable="false">Utérus myomateux</th>
                                                    <th data-field="GEU/GEUR" data-editable="false">GEU/GEUR</th>
                                                    <th data-field="Multiparité" data-editable="false">Multiparité </th>
                                                    <th data-field="Cancer_Endomètre" data-editable="false">Cancer Endomètre </th>
                                                    <th data-field="Cancer_col_utérus" data-editable="false">Cancer col utérus</th>
                                                    <th data-field="Lésions_précancéreuses">Lésions précancéreuses</th>
                                                    <th data-field="Kyste_Ovarien">Kyste Ovarien</th>
                                                    <th data-field="Abcès_Tuboovarien" data-editable="false">Abcès Tuboovarien</th>
                                                    <th data-field="Béance_cervicale" data-editable="false">Béance cervicale</th>
                                            ...
                                            <tr>
                                                    ...
                                                    <td>{{$indication->Utérus_cicatriciel}}</td>
                                                    <td>{{$indication->Utérus_myomateux}}</td>
                                                    <td>{{$indication->GEU}}</td>
                                                    <td>{{$indication->Multiparité}}</td>
                                                    <td >{{$indication->Cancer_Endomètre}}</td>
                                                    <td>{{$indication->Cancer_col_utérus}}</td>
                                                    <td>{{$indication->Lésions_précancéreuses}}</td>
                                                    <td>{{$indication->Kyste_Ovarien}}</td>
                                                    <td>{{$indication->Abcès_Tuboovarien}}</td>
                                                    <td>{{$indication->Béance_cervicale}}</td>
