                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Procedure</span>
                                            </li>
                                        </ul>
                                    </div>
                        </div>
                                ...
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                         <form action="{{route('procedures.store')}}" method="POST">
                                             ...
                                             <div class="form-group-inner">
                                              <div class="row">
                                               ...
                                               <div class="row">
                                                 ...
                                                 <div class="col-lg-4">
                                                      <input type="text" name="Sondage_vésical" class="form-control" required>
                                                 </div>
                                               </div>
                                               <div class="row">
                                                 <div class="col-lg-2">
                                           ...
                                           <a href="{{url('/procedure')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
