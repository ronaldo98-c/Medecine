                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Medecins</span>
                                            </li>
                                        </ul>
                                    </div>
                        </div>
                                     ...
                                     <div class="all-form-element-inner">
                                        <form action="{{route('medecins.update',$medecin)}}" method="POST">
                                            ...
                                            <div class="form-group-inner">
                                                 <div class="row">
                                                      <div class="col-lg-2">
                                                         <label class="login2 pull-right pull-right-pro">Nom Du Medecin</label>
                                                      </div>
                                                      <div class="col-lg-7">
                                                         <input type="text" class="form-control" value="{{old('Nom')?:$medecin->Nom}}" name="Nom"/>
                                                      </div>
                                                   </div>
                                                   <div class="row">
                                                      <div class="col-lg-2">
                                                         <label class="login2 pull-right pull-right-pro">PreNom Du Medecin</label>
                                                      </div>
                                                      <div class="col-lg-7">
                                                          <input type="text" class="form-control" value="{{old('Prenom')?:$medecin->Prenom}}" name="PreNom"/>
                                                       </div>
                                                   </div>
                                            </div>
                                             <div class="form-group-inner">
                                                      ...
                                                      <div class="col-lg-2"></div>
                                                         <div class="col-lg-7">
                                                           <div class="login-horizental cancel-wp pull-left">
                                                              <a href="../../medecin"><button class="btn btn-white" >Cancel</button></a>
