                             ...
                             <div class="row">
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                        <form action="{{route('traitements.update',$traitement)}}" method="POST">
                                            {{csrf_field()}}
                                            {{method_field('PUT')}}
                                             <div class="form-group-inner"> 
                                         <div class="row">
                                          <div class="col-lg-6">
                                              <textarea name="Traitement_Medicamenteux"  title="Traitement Medicamenteux" class="form-control"  id="" cols="30" rows="10">{{$traitement->Traitement_Medicamenteux}}</textarea>
                                           </div>
                                           <div class="col-lg-6">
                                              <textarea name="Traitement_Non_Medicamenteux"  title="Traitement Non Medicamenteuxr" class="form-control"  id="" cols="30" rows="10">{{$traitement->Traitement_Non_Medicamenteux}}</textarea>
                                           </div>
                                            </div>    
                                             </div>
                                             <div class="form-group-inner">
                                           ...
                                           <a href="{{route('traitements.index')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
