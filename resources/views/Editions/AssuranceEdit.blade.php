                                ...
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                        <form action="{{route('assurances.update',$assurance)}}" method="POST">
                                            ...
                                            <div class="row">
                                             <div class="col-lg-6">
                                               <input type="text" name="Nom" id="" class="form-control" title="Nom de l'assurance" value="{{$assurance->Nom}}" required>        
                                              </div>
                                               <div class="col-lg-6">
                                                  <select name="Localisation" id="" class="form-control" title="Localisation De L'Assurance">
                                                  <option>{{$assurance->Localisation}}</option>
                                        ...
                                        <div class="row">
                                                <div class="col-lg-6">
                                                 ...
                                                 <option>{{$assurance->Status_Juridique}}</option>
                                                  <option>SA</option>
                                                  <option>SARL</option>
                                                  <option>SAS</option>
                                                 </select>
                                                ...
                                                <div class="col-lg-6">
                                                  <input name="Capital"  title="Capital en FCFA" class="form-control" placeholder="Capital en FCFA "value="{{$assurance->Capital}}" required>
                                               </div>
                                        </div>  
                                             </div>
                                             <div class="form-group-inner">
                                           ...
                                           <a href="{{route('assurances.index')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
