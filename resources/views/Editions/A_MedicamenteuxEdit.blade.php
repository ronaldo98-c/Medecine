                             ...
                             <div class="row">
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                  <select name="Antiépileptiques" class="form-control" placeholder="Antiépileptique">
                                                    <option>Antiépileptiques:{{$a_medicamenteux->Antiépileptiques}}</option>
                                                    <option>Oui</option>
                                                    <option>Non</option>
                                                  </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                  <select name="Hypocholestérolemiants" class="form-control" placeholder="Hypocholesterolemiant">
                                                    <option>Hypocholestérolemiants:{{$a_medicamenteux->Hypocholestérolemiants}}</option>
                                                    <option>Oui</option>
                                                    <option>Non</option>
                                                  </select>
                                            </div>
                                            <div class="col-lg-6">
                                                 <select name="Antidépresseurs" class="form-control" placeholder="Antidépresseur">
                                                    <option>Antidépresseurs:{{$a_medicamenteux->Antidépresseurs}}</option>
                                                    <option>Oui</option>
                                                    <option>Non</option>
                                                 </select>
                                            </div>
