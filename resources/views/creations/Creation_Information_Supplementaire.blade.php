                             ...
                             <div class="row">
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                         <form action="{{route('information_supplementaires.store')}}" method="POST">
                                            {{csrf_field()}}
                                             <div class="form-group-inner">
                                              <div class="row">
                                                 <div class="col-lg-2">
                                                   <center><label class="login2 pull-right pull-right-pro">Protocole sécurité</label></center>
                                                 </div>
                                                 <div class="col-lg-4">
                                                      <input type="text" class="form-control" name="Protocole_Securite">
                                                 </div>
                                                 <div class="col-lg-2">
                                                   <label class="login2 pull-right pull-right-pro">Pansement</label>
                                                 </div>
                                                 <div class="col-lg-4">
                                                     <input type="text" class="form-control" name="Pansement">
                                                 </div>
                                               </div>
                                               <div class="row">
                                                 <div class="col-lg-2">
                                                 ...
                                                 <div class="col-lg-4">
                                                     <input type="text" class="form-control" name="Diurèse">
                                                 </div>
                                               </div>
                                               <div class="row">
                                                <div class="col-lg-2">
                                           ...
                                           <a href="{{url('/information_supplementaire')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
