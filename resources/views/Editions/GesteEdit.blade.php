                             ...
                             <div class="row">
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                         <form action="{{route('gestes.update',$geste)}}" method="POST">
                                            {{csrf_field()}}
                                            {{method_field('PUT')}}
                                              ...
                                              <div class="row">
                                                 ...
                                                 <div class="col-lg-4">
                                                      <select name="Dissection" id="" class="form-control">
                                                          <option>{{$geste->Dissection}}</option>
                                                          <option>Oui</option>
                                                          <option>Non</option>
                                               ...
                                               <div class="row">
                                                 ...
                                                 <div class="col-lg-4">
                                                      <select name="Nom_Medecin" class="form-control">
                                                         <option>{{$geste->Nom_Medecin}}</option>
                                                         @if(count($medecins) > 0)
                                                 ...
                                                 <div class="col-lg-4">
                                                      <select name="Nom_Patient" id="" class="form-control">
                                                       <option>{{$geste->Nom_Patient}}</option>
                                                       @if(count($patients) > 0)
                                               ...
                                               <div class="row">
                                                 ...
                                                 <div class="col-lg-4">
                                                      <select name="Nom_Service" id="" class="form-control">
                                                       <option>{{$geste->Nom_Service}}</option>
                                                       @if(count($services) > 0)
                                           ...
                                           <a href="{{route('gestes.index')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
