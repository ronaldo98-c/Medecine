                             ...
                             <div class="row">
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                        <form action="{{route('surveillances.update',$surveillance)}}" method="POST">
                                            {{csrf_field()}}
                                            {{method_field('PUT')}}
                                            <div class="form-group-inner">
                                            <div class="row">
                                              <div class="col-lg-6">
                                                  <select name="patient_nom" id="" class="form-control" title="Nom Du Patient">
                                                     <option>{{$surveillance->patient_nom}}</option>
                                                      @if(count($patients) > 0)
                                            ...
                                            <div class="row">
                                              <div class="col-lg-6">
                                                  <select name="patient_prenom" id="" class="form-control" title="Prenom Du Patient">
                                                     <option>{{$surveillance->patient_prenom}}</option>
                                                      @if(count($patients) > 0)
                                                      @foreach($patients as $patient)
                                              ...
                                              <div class="col-lg-6">
                                                <select name="medecin_numero_ordre" id="" class="form-control" title="Numero Ordre Du Medecin">
                                                 <option>{{$surveillance->medecin_numero_ordre}}</option>
                                                  @if(count($medecins) > 0)
                                        ...
                                        <div class="row">
                                          <div class="col-lg-6">
                                              <textarea name="Element_A_Surveiller"  title="Elements A Surveiller" class="form-control" id="" cols="30" rows="10">{{$surveillance->Element_A_Surveiller}}</textarea>
                                           </div>
                                        </div>   
                                             </div>
                                             <div class="form-group-inner">
                                           ...
                                           <a href="{{route('surveillances.index')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
