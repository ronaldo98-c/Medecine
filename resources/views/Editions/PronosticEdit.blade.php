                             ...
                             <div class="row">
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                        <form action="{{route('pronostics.update',$pronostic)}}" method="POST">
                                            {{csrf_field()}}
                                            {{method_field('PUT')}}
                                            ...
                                            <div class="row">
                                                  <div class="col-lg-6">
                                                     <select name="Nature" id="" class="form-control" title="Nature De L'evolution De La Sante Du Patient">
                                                        <option>{{$pronostic->Nature}}</option>
                                                  ...
                                                  <div class="col-lg-6">
                                                     <input type="date" name="Date" title="Date Prochain Rebdez-vous" value="{{$pronostic->Date}}" class="form-control">
                                                  </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                     <select name="medecin_id" id="" class="form-control" title="Identifiant Du Medecin">
                                                        <option>{{$pronostic->medecin_id}}</option>
                                                        @if(count($medecins) > 0)
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select name="diagnostic_id" id="" class="form-control" title="Identifiant Du Diagnostic">
                                                          <option>{{$pronostic->diagnostic_id}}</option>
                                           ...
                                           <a href="{{route('pronostics.index')}}"><button class="btn btn-white cancel" >Cancel</button></a>
                                          </div>
                                        </div>
                                       </div>
                                    </div>
