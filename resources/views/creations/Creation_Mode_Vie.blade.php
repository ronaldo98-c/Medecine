                             ...
                             <div class="row">
                                <div class="col-lg-9">
                                     <div class="all-form-element-inner">
                                         <form action="{{route('mode_vies.store')}}" method="POST">
                                            {{csrf_field()}}
                                          <div class="form-group-inner">
                                            <div class="row">
                                            <div class="col-lg-6">
                                                 <select name="Tabac" title="consommation du tabac" class="form-control">
                                                    <option>Tabac</option>
                                            ...
                                            <div class="col-lg-6">
                                                  <select name="Café" title="consommation du Café" class="form-control">
                                                      <option>Café</option>
                                          ...
                                          <div class="row">
                                             <div class="col-lg-6">
                                                  <input type="number" name="Nombre_Cigarette" title="Entrer le nombre en moyen par jour" class="form-control" required>
                                             </div>
                                             <div class="col-lg-6">
                                                <input type="number" name="Nombre_Année"  title="Entrer le nombre Année" class="form-control" required>
                                             </div>
                                           </div>
                                           <br>
                                           <div class="row">
                                              <div class="col-lg-6">
                                                 <select name="Alcool" title="consommation Alcool" class="form-control">
                                            ...
                                            <div class="row">
                                               <div class="col-lg-6">
                                                    <input type="text"title="Entrer le Pourcentage Alcool" name="Pourcentage_Alcool" placeholder="Entrer le Pourcentage Alcool" class="form-control" required>
                                               </div>
                                               <div class="col-lg-6">
                                                  <input type="text" name="Volume_Quotidien" class="form-control"title="Entrer le Volume Quotidien" placeholder="Entrer le Volume Quotidien" class="form-control" required>
                                               </div>
                                            </div>
                                         </div>
                                             <div class="form-group-inner">
