                   ...
                   <div class="modal-dialog">
                      <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('a_chirugicaus.store')}}" method="POST">
                                    {{csrf_field()}}
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                              <input type="date" name="date" class="form-control" title="Indiquer la date si chirurgie definie" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <textarea name="Autre_Type"  cols="30" rows="10" class="form-control"title="Definir un autre type de chirugie" placeholder="Definir un autre type de chirugie"></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Antécédents <span class="table-project-n">chirugicaux</span> </h1>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="name" data-editable="false">Nom Chirurgie</th>
                                                    <th data-field="email" data-editable="false">Date</th>
                                                    <th data-field="Hypocholestérolemiant" data-editable="false">Type</th>
                                                    <th data-field="Antidépresseurs" data-editable="false">Autre Type</th>
                                                    <th data-field="modifier" data-editable="false">Modifier</th>
                                                    <th data-field="supprimer" data-editable="false">Supprimer</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                              @if(count($a_chirugicaus) > 0)
                                              @foreach($a_chirugicaus as $a_chirugicaux)
                                              <tr>
                                                    <td>{{$a_chirugicaux->id}}</td>
                                                    <td>{{$a_chirugicaux->patient_id}}</td>
                                                    <td>{{$a_chirugicaux->patient_name}}</td>
                                                    <td>{{$a_chirugicaux->Nom_Chirurgie}}</td>
                                                    <td>{{$a_chirugicaux->date}}</td>
                                                    <td>{{$a_chirugicaux->Type}}</td>
                                                    <td>{{$a_chirugicaux->Autre_Type}}</td>
                                                    <td ><a href="{{route('a_chirugicaus.edit',$a_chirugicaux)}}"><img src="img/logo/edit.png" alt=""></a></td>
                                                    <td><a href="{{route('a_chirugicaus.destroy',$a_chirugicaux)}}" data-method="DELETE" data-confirm="Etes vous sure?"><img src="img/logo/delete.png" alt=""></a></td>
                                                </tr>
                                                @endforeach
                                               @else
                                               <tr>
